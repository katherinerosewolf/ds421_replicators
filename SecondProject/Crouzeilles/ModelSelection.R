...
df_r2_estimate<-data.frame(matrix(unlist(r2_estimate), nrow=10000, byrow=T))
...
df_Coef_estimate<-data.frame(matrix(unlist(Coef_estimate), nrow=10000, byrow=T))
df_Coef_se<-data.frame(matrix(unlist(Coef_se), nrow=10000, byrow=T))
